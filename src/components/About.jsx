  ...
  return (
    <motion.div id='about' className='flex flex-col gap-20' animate={animation}>
      ...
      <div className='flex flex-col gap-5'>
        ...
        <p ref={ref} className='leading-7'> <span className='text-xl font-bold text-gray-500'>Helping people to learn programming has been an interesting ideo to me these days!</span><br />
