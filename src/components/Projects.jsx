      ...
      <div className='flex flex-col gap-10 '>
        ...
        <motion.div className='flex gap-5 flex-wrap justify-center' animate={projectsAnimation} >
          {topProjectsArr.map(project => (
              <motion.div className='flex flex-col rounded items-center bg-gray-300 xl:w-1/6 lg:w-1/4 md:w-1/3 sm:w-1/3'>
                  <div className=''>
      ...
      <div className='flex flex-col gap-10'>
        ...
        <div className='flex flex-wrap gap-5 items-center justify-center'>
          {projects.filter(project => project.type == "APIs").map((projectCard, id) => (
            <motion.div className='flex flex-col gap-4 justify-center items-center bg-gray-300 rounded-md pb-4 xl:w-1/5 lg:w-1/2 md:w-1/2 sm:w-1/2  hover:scale-105 transition-all'>
      ...
      <div className='flex flex-col gap-10'>
        ...
        <div className='flex flex-wrap gap-5 items-center justify-center'>
          {projects.filter(project => project.type == "HTML, CSS & VanillaJS").map(projectCard => (
            <motion.div className='flex flex-col gap-4 justify-center items-center bg-gray-300 rounded-md pb-4 xl:w-1/6 lg:w-1/2 md:w-1/2 sm:w-1/ hover:scale-105 transition-all'>
      ...
      <div className='flex flex-col gap-10'>
        ...
        <div className='flex flex-wrap gap-5 items-center justify-center'>
          {projects.filter(project => project.type == "React Project").map(projectCard => (
            <motion.div className='flex flex-col gap-4 justify-center items-center bg-gray-300 rounded-md pb-4 xl:w-1/6 lg:w-1/3 md:w-1/3 sm:w-1/2 hover:scale-105 transition-all '>
              <div className=''>
